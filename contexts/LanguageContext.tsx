...
const translations = {
  vi: {
    ...
    guestOutRooms: 'Khách ra ngoài',
    cleaningRooms: 'Đang dọn dẹp',
    maintenanceRooms: 'Bảo trì',
    bookedRooms: 'Đã đặt',
    dirtyRooms: 'Phòng bẩn',
    revenue: 'Doanh thu',
    todayRevenue: 'Hôm nay',
    ...
    seeAll: 'Xem tất cả',
    noCheckInToday: 'Không có check-in hôm nay',
    noCheckOutToday: 'Không có check-out hôm nay',
    selectHotel2: 'Chọn khách sạn',
  ...
  en: {
    ...
    noCheckOutToday: 'No check-out today',
    selectHotel2: 'Select Hotel',
